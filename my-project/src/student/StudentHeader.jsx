...
export default function StudentHeader({ title = "Dashboard", toggleSidebar = () => {} }) {
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="leading-tight">
          ...
          {userData?.matricule && (
            <p className="text-xs text-gray-500">Matricule: {userData.matricule}</p>
          )}
        </div>
      </div>
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="hidden md:flex flex-col items-start leading-tight">
            <span className="text-gray-800 font-semibold text-sm">{userData?.name || "User"}</span>
          ...
          <FiChevronDown
            className={`
              hidden md:block text-gray-500 text-sm transition-transform duration-200
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-600 flex items-center gap-1 truncate">
                      ...
                      <span className="truncate">{userData?.email || "student@school.com"}</span>
                    </p>
