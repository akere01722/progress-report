...
import { FiMenu, FiLogOut, FiSettings, FiMail, FiChevronDown } from "react-icons/fi";
...
export default function AdminHeader({ title = "Dashboard", toggleSidebar }) {
  ...
  return (
    ...
    >
      ...
      {/* RIGHT SECTION - Profile Dropdown (beautified) */}
      <div className="relative">
        ...
        >
          ...
          <div className="hidden md:flex flex-col items-start leading-tight">
            ...
            <span className="text-gray-500 text-xs">
              {getRoleDisplay(userData?.role || "admin")}
            </span>
          </div>
        ...
        {dropdownOpen && (
          <>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-600 flex items-center gap-1 truncate">
                      ...
                      <span className="truncate">{userData?.email || "admin@school.com"}</span>
                    </p>
              ...
              <div className="py-2">
                <button
                  ...
                  className="
                    ...
                    hover:bg-blue-50/70 transition
                  "
                >
                  <span className="w-9 h-9 rounded-xl bg-gray-100 group-hover:bg-white flex items-center justify-center">
            ...
            {/* local keyframes (Tailwind arbitrary animate needs this in global css if not supported) */}
            <style>
              {`
                @keyframes dropdown {
